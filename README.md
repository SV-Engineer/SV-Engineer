...
## Coding Philosophy
&nbsp;&nbsp;Despite the tedium it may add, I believe code should be written with the reader in mind. No, I don't mean to imply that I impede myself from getting work done in the short term. I mean to imply that I do as best as I can to balance the short term needs with the long term needs of whatever codebase I am working on. The work I do sometimes strays from this philosophy and I take great care to bring it back to compatibility. Why? Two main reasons that are not wholly independent. The first reason is that if I have to come back to my code months later, I want to be able to quickly get back up to speed on what decisions were made and how it is organized; and the second reason is the direct corollary in that I wish to enable someone else to understand what the code does in the event that I am not available. This all comes back to enabling the user to update and/or modify the code easily without completely breaking it.

&nbsp;&nbsp;Working in industry for a few years has taught me the sheer importance of organization. Furthermore it has taught me that I should stick to this philosophy as best as I can. I frequently observe that some of my peers and even some of lower management choose to ignore the long term consequences of some coding organization decisions in favor of "just getting the job done." When the consequences finally catch up, I have found it is almost always costly in terms of engineering time or in other cases, missed customer samples. If that isn't bad enough, technical debt seems to be an ever growing problem around any code base these individuals touch such that future projects are guaranteed to carry over mistakes and thus be plagued with extra tedium and difficulty that should not exist in the first place. This is of course not true for all of my peers and I do not wish to imply there are not positive behaviors to observe as well. In fact I work with some incredibly talented individuals. This paragraph only exists to highlight an observed problem (that likely exists in any workplace that deals with code in any form) and what I try to avoid when I make decisions in writing code.
